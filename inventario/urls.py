...
urlpatterns = [
    ...
    path("producto/<int:pk>/aprobar/<str:accion>/", views.aprobar_producto, name="aprobar_producto"),
    ...
    path("pedido/<int:pk>/tomar/", views.tomar_pedido, name="tomar_pedido"),
    path("pedido/<int:pk>/liberar/", views.liberar_pedido, name="liberar_pedido"),
    path("pedidos/", views.pedidos_empleado, name="pedidos_empleado"),
    path("empleado/ubicacion/", views.guardar_ubicacion, name="guardar_ubicacion"),
    ...
    path("token-empresa/", views.token_empresa_gestion, name="token_empresa_gestion"),
    path(
        "api/empresa/datos/",
        views.api_datos_empresa,
        name="api_datos_empresa",
    ),
    path(
        "api/empresa/pedidos/",
        views.api_pedidos_empresa,
        name="api_pedidos_empresa",
    ),
